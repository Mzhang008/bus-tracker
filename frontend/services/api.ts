...
// ---------------------------------------------------------------------------
// Static GTFS route shapes (generated by generateGeoJSON.js)
// ---------------------------------------------------------------------------
...
export async function fetchRouteShapes(): Promise<GeoJSONFeatureCollection> {
  return apiFetch<GeoJSONFeatureCollection>("/static/routes.geojson", 30_000);
}

export async function fetchAvailableRoutes(): Promise<RouteInfo[]> {
  const data = await apiFetch<{ routes: RouteInfo[] }>("/static/routes");
  return data.routes;
}
